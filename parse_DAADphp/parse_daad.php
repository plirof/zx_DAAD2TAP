<?php
/*
220606 - parser_v005.4 
220604 - parser_v003 

ToDO:
https://www.w3schools.com/howto/tryit.asp?filename=tryhow_css_tooltip
https://github.com/nataliapc/msx2daad/wiki/MSX2DAAD-Wiki%3A-Understanding-DSF-file-format
...
foreach(preg_split("/((\r?\n)|(\r\n?))/", $MTX) as $line){
	//echo "<h3>MTX : $line</h3>";
	//$MTX
	if(substr($line,0,1)==";") continue; //echo "<br>".$line."KKKKKKKKKKKKK";
	$mtx_idx=get_string_between($line,"/","\""); //echo "<HR>".$line."AAAAAAAAAA=".$mtx_idx;
	//if (is_numeric($mtx_idx)) {
		echo "INSIDE.............................................";
		$mtx_txt=get_string_between($line,'"','"');
		//echo "<HR>".$line."nbbbbbbbbbbb22222=".$mtx_txt;
		$mtx_array[$mtx_idx]=$mtx_txt;
	//}
	//$mtx_array[]
	print_r($mtx_array);
